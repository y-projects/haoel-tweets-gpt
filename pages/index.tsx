						...
						{showSettings && (
							<div className='w-[340px] sm:w-[400px]'>
								...
								<div className='mt-4 flex space-x-2 justify-center'>
									<div className='flex cursor-pointer items-center space-x-2 rounded-full bg-green-500 px-3 py-1 text-sm text-white hover:bg-green-600' onClick={handleSave}>
										Save
									</div>

									<div className='flex cursor-pointer items-center space-x-2 rounded-full bg-red-500 px-3 py-1 text-sm text-white hover:bg-red-600' onClick={handleClear}>
										Clear
									</div>
								</div>
							</div>
										...
										<div key={index}>
											<div className='mt-4 border border-zinc-600 rounded-lg p-4'>
												<div className='flex justify-between'>
													...
													<a className='hover:opacity-50 ml-2' href={chunk.tweet_url} target='_blank' rel='noreferrer'>
														<IconExternalLink />
													</a>
												</div>
